...
class FixtureFlatSpecSpec extends org.scalatest.Spec with PrivateMethodTester with SharedHelpers {
  ...
  describe("A fixture.FlatSpec ") {
    it("A fixture.Spec should return the test names in order of registration from testNames") {
      val a = new FixtureFlatSpec with SimpleWithFixture with ShouldVerb {
        type Fixture = String
      ...
      val b = new FixtureFlatSpec with SimpleWithFixture with ShouldVerb {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      }
      ...
      val c = new FixtureFlatSpec with SimpleWithFixture with ShouldVerb {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
    ...
    it("should throw DuplicateTestNameException if a duplicate test name registration is attempted") {
      ...
      intercept[DuplicateTestNameException] {
        new FixtureFlatSpec with SimpleWithFixture {
          type Fixture = String
          def withFixture(fun: String => Unit) {}
    ...
    it("should run tests registered via the 'it can behave like' syntax") {
      ...
      class MyConfigFlatSpec extends FixtureFlatSpec with SimpleWithFixture with SharedFlatSpecTests {
        type Fixture = String
        def withFixture(fun: String => Unit) {
          fun("hi")
        }
    ...
    it("should return a correct tags map from the tags method, when using regular (not shorthand)" +
      ...
      val a = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
        ignore should "test this" in { fixture => }
      ...
      val b = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      ...
      val c = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      ...
      val d = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      ...
      val e = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      ...
      val f = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      ...
      val g = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
    ...
    it("should return a correct tags map from the tags method, when using shorthand notation") {
      ...
      val b = new FixtureFlatSpec with SimpleWithFixture with CanVerb {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      ...
      val c = new FixtureFlatSpec with SimpleWithFixture with MustVerb {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      ...
      val d = new FixtureFlatSpec with SimpleWithFixture with MustVerb {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      ...
      val e = new FixtureFlatSpec with SimpleWithFixture with MustVerb {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      ...
      val f = new FixtureFlatSpec with SimpleWithFixture with CanVerb {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
      ...
      val g = new FixtureFlatSpec with SimpleWithFixture with ShouldVerb {
        type Fixture = String
        def withFixture(fun: String => Unit) {}
    ...
    class TestWasCalledSuite extends FixtureFlatSpec with SimpleWithFixture {
      type Fixture = String
    ...
    it("should run only those tests selected by the tags to include and exclude sets") {
      ...
      val h = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) { fun("hi") }
        var theTestThisCalled = false
        var theTestThatCalled = false
      ...
      val i = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) { fun("hi") }
        var theTestThisCalled = false
        var theTestThatCalled = false
      ...
      val j = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) { fun("hi") }
        var theTestThisCalled = false
        var theTestThatCalled = false
      ...
      val k = new FixtureFlatSpec with SimpleWithFixture {
        type Fixture = String
        def withFixture(fun: String => Unit) { fun("hi") }
        var theTestThisCalled = false
        var theTestThatCalled = false
