...
// This is ShouldContainElementSpec, except that instead of mixing in the ShouldMatchers trait,
// I'm importing the members of the ShouldMatchers companion object. This tests that the
// importing approach works.
class ImportShouldMatchersSpec extends Spec with Checkers with ReturnsNormallyThrowsAssertion {
