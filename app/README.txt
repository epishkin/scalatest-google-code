...
Although ScalaTest 0.9.6 sports a pre-1.0 version number, ScalaTest is mature,
...
/scalatest-0.9.6/doc directory. Look first at the documentation for trait
...
scala -classpath scalatest-0.9.6.jar org.scalatest.tools.Runner -p "scalatest-0.9.6-tests.jar" -g -s org.scalatest.SuiteSuite

This command will run and just print results to the standard output:

scala -classpath scalatest-0.9.6.jar org.scalatest.tools.Runner -p "scalatest-0.9.6-tests.jar" -o -s org.scalatest.SuiteSuite

ScalaTest 0.9.6 was tested with Scala version 2.7.5.final, so it is not
