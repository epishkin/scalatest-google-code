 ...
 * the clean up problem but still avoids <code>var</code>s is to use <a href="fixture/FixtureSpec.html"><code>FixtureSpec</code></a> trait in the
 ...
 * doing so before and after invoking the test function in the <code>withFixture</code> method of a <code>FixtureSpec</code>:
 * </p>
 *
 * <pre>
