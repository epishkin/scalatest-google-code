...
/**
 * A sister trait to <code>org.scalatest.WordSpec</code>, which passes a fixture object into each test.
 *
 * <p>
 * This trait behaves similarly to trait <code>org.scalatest.WordSpec</code>, except that each test takes a fixture object. The type of the
