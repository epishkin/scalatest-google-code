...
trait FeatureSpec extends FixtureSuite { thisSuite =>
  ...
  protected def scenario(specText: String, testTags: Tag*)(testFun: FixtureParam => Any) {
    ...
    registerTest(Resources("scenario", specText), testFun, "scenarioCannotAppearInsideAnotherScenario", "FeatureSpec.scala", "scenario", testTags: _*)
  }
  ...
  protected def ignore(specText: String, testTags: Tag*)(testFun: FixtureParam => Any) {
    registerIgnoredTest(Resources("scenario", specText), testFun , "ignoreCannotAppearInsideAScenario", "FeatureSpec.scala", "ignore", testTags: _*)
  }
