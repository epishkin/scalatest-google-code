...
import org.scalatest.ValueOnPartialFunction._
import org.scalatest.matchers.ShouldMatchers
import org.scalatest.SharedHelpers.thisLineNumber

class ValueOnPartialFunctionSpec extends FunSpec with ShouldMatchers {
  ...
  describe("values on PartialFunction") {
    ...
    it("should throw TestFailedException when is not defined") {
      ...
      caught.failedCodeFileName.value should be ("ValueOnPartialFunctionSpec.scala")
