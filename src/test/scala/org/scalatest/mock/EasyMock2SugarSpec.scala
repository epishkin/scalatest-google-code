...
class EasyMock2SugarSpec extends FlatSpec with ShouldMatchers with SharedHelpers {
  "The EasyMock2Sugar trait's whenExecuting method" should
          "work with multiple mocks passed in" in {
    val a = new Suite with EasyMock2Sugar {
