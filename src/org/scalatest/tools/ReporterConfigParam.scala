...
private[tools] case object FilterTestSucceeded extends ReporterConfigParam("D")
...
private[tools] case object PresentVerbose extends ReporterConfigParam("V")
private[tools] case object PresentColor extends ReporterConfigParam("C")
