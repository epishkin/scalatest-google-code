 ...
 * @param config a <code>Map</code> of key-value pairs that can be used by custom <code>Reporter</code>s
 * @param formatter an optional formatter that provides extra information that can be used by reporters in determining
 *        how to present this event to the user
...
object RunStarting {
  ...
  def apply(
    ...
    apply(ordinal, testCount, config, formatter, payload, Thread.currentThread.getName, (new Date).getTime)
  }
  ...
  def apply(
    ...
    apply(ordinal, testCount, config, formatter, None, Thread.currentThread.getName, (new Date).getTime)
  }
  ...
  def apply(
    ...
    apply(ordinal, testCount, config, None, None, Thread.currentThread.getName, (new Date).getTime)
  }
}
