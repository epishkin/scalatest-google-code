...
/**
 * A sister trait to <code>org.scalatest.FeatureSpec</code>, which passes a fixture object into each test.
 *
 * <p>
 * This trait behaves similarly to trait <code>org.scalatest.FeatureSpec</code>, except that each test takes a fixture object. The type of the
 ...
 * <li>write scenarios that take a <code>Fixture</code></li>
 * </ol>
 *
 * <p>
 * Here's an example:
