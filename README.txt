...
/scalatest-1.4/doc directory. Look first at the documentation for trait
...
scala -classpath scalatest-1.4.jar org.scalatest.tools.Runner -p "scalatest-1.4-tests.jar" -g -s org.scalatest.SuiteSuite

This command will run and just print results to the standard output:

scala -classpath scalatest-1.4.jar org.scalatest.tools.Runner -p "scalatest-1.4-tests.jar" -o -s org.scalatest.SuiteSuite

ScalaTest 1.4 was compile and tested with Scala version 2.9.0, so it is not
